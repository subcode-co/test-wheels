    ...
    var w = class {
        ...
        resize() {
            ...
            ((this.canvas.style.width =
                this._canvasContainer.clientWidth + "px"),
                (this.canvas.style.height =
                    this._canvasContainer.clientHeight + "px"));
            let [e, t] = [
        ...
        draw(e = 0) {
            ...
            ((t.textBaseline = "middle"),
                ...
                (t.font =
                    this._itemLabelFontSize + "px " + this.itemLabelFont));
        ...
        drawItemImages(e, t = []) {
            for (let [s, n] of t.entries()) {
                ...
                (e.translate(
                    this._center.x +
                        Math.cos(m(a + -90)) *
                            (this._actualRadius * r.imageRadius),
                    this._center.y +
                        Math.sin(m(a + -90)) *
                            (this._actualRadius * r.imageRadius),
                ),
            ...
            for (let [a, d] of t.entries()) {
                let h = this._items[a],
                    C =
                        ...
                        this._itemLabelColors[
                            a % this._itemLabelColors.length
                        ] ||
                        "transparent";
                ...
                if (
                    ...
                    (this.itemLabelAlign === "left"
                        ...
                        : this.itemLabelAlign === "center" &&
                          (f = this._labelMaxWidth / 2),
                        e.beginPath(),
                        e.moveTo(f, 0),
        ...
        animateRotation(e = 0) {
            if (this._spinToTimeEnd !== null) {
                ...
                ((this.rotation =
                    ...
                    n * this._spinToEasingFunction(s)),
                    this.refresh());
                return;
            }
        ...
        getItemAngles(e = 0) {
            ...
            for (let d of this._items)
                ((n = d.weight * s),
                    a.push({ start: r, end: r + n }),
                    (r += n));
            return (
                this._items.length > 1 &&
                    (a[a.length - 1].end = a[0].start + 360),
                a
            );
        }
        refresh() {
        ...
        beginSpin(e = 0, t = "") {
            (this.stop(),
                (this._rotationSpeed = this.limitSpeed(
                    e,
        ...
        set itemLabelAlign(e) {
            ((this._itemLabelAlign = l({
                ...
                errorMessage:
                    "Wheel.itemLabelAlign must be one of Constants.AlignText",
        ...
        set onCurrentIndexChange(e) {
            this._onCurrentIndexChange = l({
                ...
                errorMessage:
                    "Wheel.onCurrentIndexChange must be a function or null",
        ...
        set overlayImage(e) {
            ((this._overlayImage = l({
                ...
                isValid: e instanceof HTMLImageElement || e === null,
                errorMessage:
                    "Wheel.overlayImage must be a HTMLImageElement or null",
        ...
        set pointerAngle(e) {
            ((this._pointerAngle = l({
                ...
                isValid: u(e) && e >= 0,
                errorMessage:
                    "Wheel.pointerAngle must be a number between 0 and 360",
...
// Expose the library to the window object so it can be used globally
...
(function () {
    ...
    // Variables for DOM elements (initialized in DOMContentLoaded and refreshed as needed)
    var phoneInput, phoneError, phoneSuccess, startGameBtn;
    var phoneSection, wheelSection, wheelEl, logoRef;
    var spinBtn, spinBtnText;
    var resultModal, resultDisplay, resultPhoneNumber;
    var claimResultBtn, whatsappBtn, saveResultForm;
    var userPhoneDisplayEl, spinsCountDisplay, winnersCountDisplay;
    var closeResultModalBtn;
    ...
    function getElements() {
        ...
        logoRef = document.getElementById("logoRef");
        spinBtn = document.getElementById("spinBtn");
        spinBtnText = document.getElementById("spinBtnText");
        resultModal = document.getElementById("resultModal");
        resultDisplay = document.getElementById("resultDisplay");
        resultPhoneNumber = document.getElementById("resultPhoneNumber");
        claimResultBtn = document.getElementById("claimResultBtn");
        whatsappBtn = document.getElementById("whatsappBtn");
        saveResultForm = document.getElementById("saveResultForm");
        userPhoneDisplayEl = document.getElementById("userPhoneDisplay");
        spinsCountDisplay = document.getElementById("spinsCountDisplay");
        winnersCountDisplay = document.getElementById("winnersCountDisplay");
    ...
    function updatePhoneValidation() {
        ...
        // Hide success message temporarily while typing or invalid
        ...
        if (digits.length > 0) {
            if (isValid) {
                ...
                // Show error only if near completion or obviously wrong start
                if (
                    digits.length >= 10 ||
    ...
    function showResultModal(winnerItem) {
        ...
        if (resultPhoneNumber)
            resultPhoneNumber.textContent =
                gameState.userPhoneDisplay || gameState.userPhone;
        if (resultModal) {
            /* Small delay so user sees wheel land on winning segment */
            setTimeout(function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        // Retrieve fresh DOM elements references
        getElements();

        if (phoneInput) {
            // Reset state cleanly - No forced value clearing
            ...
            // Prevent any accidental form submission/zoom on focus/click
        ...
        // Initial check in case of browser cached value
        setTimeout(updatePhoneValidation, 300);
    });
